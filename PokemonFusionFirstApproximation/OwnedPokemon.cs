...
namespace PokemonFusionFirstApproximation
{
    class OwnedPokemon
    {
        ...
        public Tuple<RedLib.PokemonTypes,RedLib.PokemonTypes> getType()
        {
            ...
            RedLib.PokemonTypes type2 = dexBase.headComponent.types.Item2;
            ...
            {
                typescores.Add(dexBase.bodyComponent.types.Item1, 2);
            }
            ...
            RedLib.PokemonTypes type1 = dexBase.headComponent.types.Item1;
            RedLib.PokemonTypes type2 = dexBase.bodyComponent.types.Item2;
